...
export class UsuarioComponent implements OnInit {
  ...
  public datosForm = this.fb.group({
    ...
    baneado: [false, Validators.required ]
  });
  ...
  nuevo(): void {
    ...
    this.datosForm.get('rol')!.setValue('USUARIO');
    this.datosForm.get('activo')!.setValue(true);
    this.datosForm.get('baneado')!.setValue(false);
  ...
  cargaDatosForm( res: any): void {
    ...
    this.datosForm.get('apellido')!.setValue(res['usuarios'].apellido);
    ...
    this.datosForm.get('baneado')!.setValue(res['usuarios'].baneado);
