...
@Component({
  selector: 'app-eventoscreados',
  templateUrl: './eventoscreados.component.html',
  styleUrls: ['./eventoscreados.component.css']
})
export class EventoscreadosComponent implements OnInit {
    ...
    private usuarioService: UsuarioService) { Object.assign(this, this.arraymes) }
    public surveyData = [
...
buildChart(array:any[]){
  ...
  var columnChart =()=> new google.visualization.ColumnChart(document.getElementById('chart_div2'));
    ...
    .subscribe( (res:any) => {
        ...
        res['eventos'].forEach( (element:any) => { //entramos en evento
          element.asistentes.forEach((usu:any) => {
              if(this.usuarioService.uid == usu.usuario){
